...
public class MenuActivity extends AppCompatActivity {
    ...
    private MediaPlayer.OnCompletionListener mCompletionListener = new MediaPlayer.OnCompletionListener() {
        ...
        public void onCompletion(MediaPlayer mediaPlayer) {
            // repeat the music wehn it is over
            mediaPlayer.reset();
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
            ...
            mMediaPlayer = MediaPlayer.create(MenuActivity.this, R.raw.main);
        ...
        twoPlayerBtn.setOnClickListener( new View.OnClickListener() {
            @Override
            //start the board game activity
            public void onClick(View v) {
                Intent intent = new Intent( MenuActivity.this,MainActivity.class );
                startActivity( intent );
                /**release media file once we leave the activity*/
                releaseMediaPlayer();
            }
        } );
